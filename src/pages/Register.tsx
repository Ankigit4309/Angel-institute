      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="text-center">
          <Link to="/" className="inline-block">
            <img 
              src="/lovable-uploads/f199d0ff-6d2b-4eda-9200-914ab86ca990.png" 
        ...
        <Card className="border-0 shadow-glow bg-background/95 backdrop-blur">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl">Create Account</CardTitle>
            <CardDescription>
              Join Angle Institute to start your coding journey
            </CardDescription>
          </CardHeader>
